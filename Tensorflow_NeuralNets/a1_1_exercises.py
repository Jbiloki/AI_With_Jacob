# -*- coding: utf-8 -*-
"""
Created on Thu Jun 29 13:28:41 2017
...
r = tf.case({tf.less(x, y): f2, tf.greater(x,y): f1}, default = f3, exclusive = True)
...
x = tf.Variable(tf.diag(tf.range(1,7)))
...
tf.where(condition, left_op, right_op)